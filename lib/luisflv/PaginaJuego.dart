...
class _PaginaJuegoState extends State<PaginaJuego> {
  ...
  Widget imagenBoton(int numero) {
    switch (numero) {
      case 0:
        return Image.asset("assets/cero_maya.png", color: Colors.black);
      case 1:
        return Image.asset("assets/uno_maya.png",
            height: 25, color: Colors.black);
      case 5:
        return Image.asset("assets/cinco_maya.png", color: Colors.black);
      default:
        return Image.asset("assets/cero_maya.png", color: Colors.black);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Conversor de numeros"),
      ),
      body: Column(
        children: [
          Expanded(
  ...
  List<List<int>> deArabigoAMaya(int numero) {
    ...
    listResults.removeWhere((lista) => lista.isEmpty);
    return listResults;
  }
}
